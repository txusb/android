package com.orango.electronic.orangetxusb.LotActivity
...
import kotlinx.android.synthetic.main.fragment_start_program.*
...
var first=true
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        WriteLf= arguments!!.getString(mmyFragment.LFID)!!
        WriteRf= arguments!!.getString(mmyFragment.RFID)!!
        WriteLr= arguments!!.getString(mmyFragment.LRID)!!
        WriteRR= arguments!!.getString(mmyFragment.RRID)!!
    ...
    override fun onCreateView(
        ...
        rootView.Relarm.setOnClickListener {
            ...
            args.putString(mmyFragment.stringYear, year)
