...
var SCAN_OR_KEY=1
    ...
    override fun onCreateView(
        ...
        rootView.program.setOnClickListener {
            ...
            args.putString(mmyFragment.LFID, insert(lf))
            args.putString(mmyFragment.LRID,insert(lr))
            args.putString(mmyFragment.RRID,  insert(Rr))
            args.putString(mmyFragment.RFID,  insert(Rf))
