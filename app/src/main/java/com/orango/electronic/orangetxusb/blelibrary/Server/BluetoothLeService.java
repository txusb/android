...
import com.orango.electronic.orangetxusb.blelibrary.EventBus.ConnectState;
import com.orango.electronic.orangetxusb.blelibrary.EventBus.ReadData;
import com.orango.electronic.orangetxusb.blelibrary.EventBus.RebackData;
import com.orango.electronic.orangetxusb.blelibrary.EventBus.WriteData;
...
public class BluetoothLeService extends Service {
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicRead(BluetoothGatt gatt,
            ...
            if(tmp.length()==check||check==0){ EventBus.getDefault().post(new ReadData(StringHexToByte(tmp)));}
        }
...
public void onCharacteristicWrite(BluetoothGatt gatt,BluetoothGattCharacteristic characteristic,int status){
    ...
    EventBus.getDefault().post(new WriteData(characteristic.getValue()));
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,
            ...
            tmp=tmp+bytesToHex(characteristic.getValue());
            Log.d("galx",tmp);
            if(tmp.length()==check||check==0){ EventBus.getDefault().post(new RebackData(StringHexToByte(tmp)));}
        }
    };
