...
import com.orango.electronic.orangetxusb.Adapter.SelectBle;
import com.orango.electronic.orangetxusb.EventBus.ConnectBle;
import com.orango.electronic.orangetxusb.blelibrary.EventBus.SerchDevice;
import com.orango.electronic.orangetxusb.blelibrary.Server.ScanDevice;
...
public class ScanBle extends AppCompatActivity {
   ...
   public  ScanDevice scan=new ScanDevice();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == 1) {
            if(grantResults[0]!=0){
                Toast.makeText(this, getResources().getString(R.string.Get_location), Toast.LENGTH_LONG).show();
    ...
    public void Event(SerchDevice a){
        try{
            if(!ble.contains(a.getDevic())&&a.getDevic().getName()!=null&&a.getDevic().getName().contains("")){
                ble.add(a.getDevic());
